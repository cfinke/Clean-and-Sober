...
function clean_and_sober_content_nav( $nav_id ) {
	...
	<?php elseif ( $wp_query->max_num_pages > 1 && ( is_home() || is_archive() || is_search() ) ) : // navigation links for home, archive, and search pages ?>
		...
		<div class="nav-next"><?php previous_posts_link( __( 'Newer posts <span class="meta-nav">&rarr;</span>', 'clean-and-sober' ) ); ?></div>
		<?php endif; ?>
...
endif; // clean_and_sober_content_nav
...
function clean_and_sober_comment( $comment, $args, $depth ) {
	...
	<li class="post pingback">
		<p><?php _e( 'Pingback:', 'clean-and-sober' ); ?> <?php comment_author_link(); ?><?php edit_comment_link( __( '(Edit)', 'clean-and-sober' ), ' ' ); ?></p>
	<?php
			break;
		default :
	?>
		...
		<article id="comment-<?php comment_ID(); ?>" class="comment">
			<footer>
				...
				<?php if ( $comment->comment_approved == '0' ) : ?>
					<em><?php _e( 'Your comment is awaiting moderation.', 'clean-and-sober' ); ?></em>
					<br />
				<?php endif; ?>
				...
				<div class="comment-meta commentmetadata">
					...
					<?php
						...
						printf( __( '%1$s at %2$s', 'clean-and-sober' ), get_comment_date(), get_comment_time() ); ?>
					</time></a>
...
endif; // ends check for clean_and_sober_comment()
...
function clean_and_sober_posted_on() {
	printf( __( 'Posted on <a href="%1$s" title="%2$s" rel="bookmark"><time class="entry-date" datetime="%3$s" pubdate>%4$s</time></a><span class="byline"> by <span class="author vcard"><a class="url fn n" href="%5$s" title="%6$s" rel="author">%7$s</a></span></span>', 'clean-and-sober' ),
